...
# TODO: At some point get back and have it auto import a theme

# Install the Solarized Dark theme for iTerm - for reference
...
# TODO: Come back and update Spectacle apps
